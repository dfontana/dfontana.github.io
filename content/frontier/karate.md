...
- [Karate-Netty](https://github.com/karatelabs/karate/tree/v1.5.2.RC2/karate-netty) can mock HTTP dependencies from a specification file.
- It's can be ran from a standalone jar, no java project required
- [Schema Validation](https://github.com/karatelabs/karate/blob/v1.5.2.RC2/README.md#schema-validation) to Contract test; while [Assertions](https://github.com/karatelabs/karate/blob/v1.5.2.RC2/README.md#payload-assertions), [Data-Driven Features](https://github.com/karatelabs/karate/blob/v1.5.2.RC2/README.md#data-driven-features), and [Data-Driven Tests](https://github.com/karatelabs/karate/blob/v1.5.2.RC2/README.md#data-driven-tests) will be very useful.
