...
[_Originally Shared as a Gist_](https://gist.github.com/dfontana/3e27ec5ea3a6f935b7322b580d3df318). ZSH setup on Windows, minus the input funny business. We'll use mintty emulated by cygwin running on cmder.
<!-- more -->
...
2. [Download cmder](https://cmder.app/) to get started (the full version!). This is a conemu derivative to run shells inside of. It's flexible and highly customizable, which tends to make it desireable. Features a quake-style drop down shell if you're that kind of person, but more importantly plays really nice with keyboard interactions.
...
2. Install dos2unix [(man page)](https://manned.org/dos2unix) with `apt-cyg install dos2unix`. This is a simple utility to convert the line endings of a file.
